...
class UIViewTests: XCTestCase {
    ...
    func testGetY() {
        ...
        let view2 = UIView(frame: CGRectMake(0, 10, 0, 0))
    ...
    func testGetWidth() {
        ...
        let view2 = UIView(frame: CGRectMake(0, 0, 10, 0))
    ...
    func testGetHeight() {
        ...
        let view2 = UIView(frame: CGRectMake(0, 0, 0, 10))
    ...
    func testGetTop() {
        let view1 = UIView(frame: CGRectMake(0, 0, 10, 10))
        XCTAssertEqual(view1.frame.origin.y, view1.top)
        XCTAssertEqual(view1.top, 0)
        let view2 = UIView(frame: CGRectMake(0, 10, 10, 10))
    ...
    func testGetRight() {
        ...
        let view2 = UIView(frame: CGRectMake(10, 0, 10, 10))
